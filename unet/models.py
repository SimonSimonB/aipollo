...
def get_weighted_sparse_categorical_crossentropy(num_classes):
...
def get_unet(img_height, img_width, img_channels, num_classes, one_hot=False):
    ...
    if one_hot:
        ...
        #weighted_scc = get_weighted_sparse_categorical_crossentropy(num_classes)
        #model.compile(optimizer='adam', loss=weighted_scc, metrics=['sparse_categorical_accuracy'])
        model.compile(optimizer='adam', loss='sparse_categorical_crossentropy', metrics=['sparse_categorical_accuracy'])
    model.summary()
