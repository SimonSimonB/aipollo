...
class CRNN(torch.nn.Module):
    def __init__(self, image_height, image_width, alphabet_size, num_subimage_features):
...
def train_real():
    ...
    crnn = CRNN(image_height=image_height, image_width=image_width, alphabet_size=alphabet_size, num_subimage_features=256)
    ...
    for epoch in range(1024):
        ...
        print(f'\nAverage train loss in epoch {epoch}: {running_loss / len(train_dataset):.4f}\n')
        ...
        print(f'\nAverage validation loss in epoch {epoch}: {running_loss / len(val_dataset):.4f}\n')
